          ...
          <div class="flex flex-col gap-6 sm:gap-8 ">
            ...
            <div class="flex justify-center md:order-last -mx-4 sm:mx-0">
              <div class="w-full max-w-full sm:max-w-2xl md:max-w-4xl lg:max-w-6xl sm:px-0">
                <img :src="centerImageSrc" alt="广告平台展示" class="w-full h-auto object-contain" />
              </div>
            </div>
              ...
              <div class="space-y-6 mb-8 px-[10%] md:px-0">
                ...
                <div class="flex gap-4">
                  <div class="flex-shrink-0">
                    <img :src="icon1Src" alt="大量精准流量" class="w-12 h-12 sm:w-16 sm:h-16 object-contain" />
                  </div>
                  <div>
                    <h3
                ...
                <div class="flex gap-4">
                  <div class="flex-shrink-0">
                    <img :src="icon3Src" alt="量身定制的全球在线营销" class="w-12 h-12 sm:w-16 sm:h-16 object-contain" />
                  </div>
                  <div>
                    <h3
                      class="font-pingfang font-medium text-[18px] sm:text-[20px] md:text-[22px] lg:text-[24px] leading-[27px] sm:leading-[30px] md:leading-[33px] lg:leading-[36px] tracking-normal text-[#747677] mb-2">
                ...
                <div class="flex gap-4">
                  <div class="flex-shrink-0">
                    <img :src="icon2Src" alt="灵活的广告投放平台" class="w-12 h-12 sm:w-16 sm:h-16 object-contain" />
                  </div>
                  <div>
                    <h3
                      class="font-pingfang font-medium text-[18px] sm:text-[20px] md:text-[22px] lg:text-[24px] leading-[27px] sm:leading-[30px] md:leading-[33px] lg:leading-[36px] tracking-normal text-[#747677] mb-2">
        ...
        <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div class="order-2 lg:order-2 flex justify-center lg:justify-end w-full px-[10px] lg:px-0">
              <div class="w-full max-w-md lg:max-w-none lg:w-[730px] lg:h-[540px]">
                <img :src="center3ImageSrc" alt="媒体资料" class="w-full h-full object-contain" />
              </div>
            </div>
