<template>
    <section :class="[bgColor, 'py-14  md:py-[120px]']">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p :class="[
                'font-pingfang font-normal text-left md:text-center text-[16px] md:text-[18px] leading-[26px] md:leading-[26px] tracking-normal text-[#93959C] max-w-[560px] mx-auto mb-[49px] md:mb-[90px]',
            ]">
                {{ description }}
            </p>
            ...
            <div :class="[
                ...
                <div v-for="item in items" :key="item.title" :class="[
                    ...
                    id === 'unique' ||
                        ...
                        id === 'browser' ||
                        id === 'digital'
                        ? 'xl:w-[373px] xl:h-[480px] shadow-[0_2px_24px_0_rgba(0,0,0,0.096)] border-none flex flex-col items-center justify-start md:pt-[68px] mx-auto max-w-[90vw]'
                        : 'py-28 shadow-[0_5px_8px_-2px_rgba(0,0,0,0.025),0_2px_3px_-1px_rgba(0,0,0,0.01)] border border-[#EEF0F4]',
                ]">
                    <SvgIcon :name="item.icon"
                        class="w-[100px] h-[100px] lg:w-[160px] lg:h-[160px] mx-auto mb-4 md:mb-[43px] object-contain" alt="图标" />
                    <h4
            ...
            <div :class="['md:hidden', id === 'digital' && 'mb-6']">
                <div :ref="scrollRef"
                    ...
                    <div v-for="(item, idx) in items" :key="item.title" :ref="(el) => setCardRef(el, idx)"
                ...
                <div class="flex justify-center gap-2 mt-2">
                    <span v-for="(_, i) in items" :key="i" class="w-2 h-2 rounded-full transition-colors"
