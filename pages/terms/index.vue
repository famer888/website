<template>
  <div class="min-h-screen bg-white flex flex-col">
    ...
    <div class="sticky top-0 md:top-16 z-[60] md:z-40 bg-gray-50 border-b border-gray-200 shadow-sm">
      <div class="max-w-7xl mx-auto">
        ...
        <nav class="flex items-center gap-4 md:gap-6 lg:gap-8 py-3 md:py-4 overflow-x-auto scrollbar-hide md:justify-center px-4 sm:px-6 lg:px-8">
          <NuxtLink
            ...
            :class="activeTab === tab.id ? 'text-blue-600 border-b-2 border-blue-600 pb-2' : 'text-gray-600 hover:text-gray-900'"
          >
            {{ tab.label }}
          </NuxtLink>
        </nav>
