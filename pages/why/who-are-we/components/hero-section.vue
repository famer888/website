<template>
  <section class="w-full space-y-[48px]">
    <div
      class="max-w-[1200px] mx-auto pt-0 md:pt-[100px] grid grid-cols-1 md:grid-cols-2"
    >
      <div
      ...
      >
        ...
        >
          我们是谁<span class="md:hidden">?</span>
        </h1>
        <div
          class="font-pingfang font-normal tracking-[0px] text-[14px] md:text-[18px] leading-[20px] md:leading-[26px] text-[#93959C] text-justify md:text-left space-y-[20px] md:space-y-0.5"
        >
...
const data = {
  description1:
    "T1 是一家创新型网络广告和数字营销公司,于2008年成立。T1 的使命是通过高效、可量化的数字营销解决方案，持续提升企业品牌与产品的商业表现。",
  description2:
    "我们的专家团队将协助您找到当前效果最佳的广告创意,并为您提供详细的流量报告。",
};
</script>
