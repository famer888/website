<template>
  <div class="min-h-screen bg-white">
          ...
          >
            ...
            <div class="relative group">
              <button
                ...
                :class="
                  activeDropdown === 'why' || route.path.startsWith('/why/')
                    ? 'text-brand'
                    : 'text-gray-700'
                "
              >
                ...
                <svg
                  class="ml-1 h-4 w-4"
                  :class="{ 'rotate-180': activeDropdown === 'why' }"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              >
                <NuxtLink
                  ...
                  :class="
                    route.path === '/why/who-are-we'
                      ? 'block mx-2 px-3 py-2 text-sm text-brand rounded-lg hover:bg-[#5380DD19]'
                      : 'block mx-2 px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-[#5380DD19]'
                  "
                >
                  我们是谁</NuxtLink
                >
            ...
            <div class="relative group">
              <button
                ...
                :class="
                  activeDropdown === 'advertiser' ||
                  route.path.startsWith('/advertiser/')
                    ? 'text-brand'
                    : 'text-gray-700'
                "
              >
                ...
                <svg
                  class="ml-1 h-4 w-4"
                  :class="{ 'rotate-180': activeDropdown === 'advertiser' }"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              >
                <NuxtLink
                  ...
                  @click="activeDropdown = null"
                  :class="
                    route.path === '/advertiser/how-to-operate'
                      ? 'block mx-2 px-3 py-2 text-sm text-brand rounded-lg hover:bg-[#5380DD19]'
                      : 'block mx-2 px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-[#5380DD19]'
                  "
                >
                ...
                >
                <NuxtLink
                  to="/advertiser/t1-dsp"
                  @click="activeDropdown = null"
                  :class="
                    route.path === '/advertiser/t1-dsp'
                      ? 'block mx-2 px-3 py-2 text-sm text-brand rounded-lg hover:bg-[#5380DD19]'
                      : 'block mx-2 px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-[#5380DD19]'
                  "
                >
                ...
                >
                <NuxtLink
                  to="/advertiser/target-function"
                  @click="activeDropdown = null"
                  :class="
                    route.path === '/advertiser/target-function'
                      ? 'block mx-2 px-3 py-2 text-sm text-brand rounded-lg hover:bg-[#5380DD19]'
                      : 'block mx-2 px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-[#5380DD19]'
                  "
                >
            ...
            <div class="relative group">
              ...
              >
                ...
                <svg
                  class="ml-1 h-4 w-4"
                  :class="{ 'rotate-180': activeDropdown === 'contact' }"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              >
                ...
                <NuxtLink
                  ...
                  @click="activeDropdown = null"
                  :class="
                    route.path === '/contact/help-center'
                      ? 'block mx-2 px-3 py-2 text-sm text-brand rounded-lg hover:bg-[#5380DD19]'
                      : 'block mx-2 px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-[#5380DD19]'
                  "
                >
                ...
                >
                <NuxtLink
                  to="/contact/quality-guide"
                  @click="activeDropdown = null"
                  :class="
                    route.path === '/contact/quality-guide'
                      ? 'block mx-2 px-3 py-2 text-sm text-brand rounded-lg hover:bg-[#5380DD19]'
                      : 'block mx-2 px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-[#5380DD19]'
                  "
                >
    ...
    <Transition name="drawer">
      <div
        v-if="mobileMenuOpen"
        class="md:hidden fixed top-16 left-0 right-0 bottom-0 z-[60]"
      >
        <!-- 背景遮罩 -->
        <div
        ...
        >
          <div class="px-0 py-0">
            ...
            <div>
              ...
              >
                ...
                <img
                  :src="openIconSrc"
                  alt="Toggle"
                  class="h-6 w-6 transition-transform -rotate-90"
                  :class="{ 'rotate-0': mobileDropdown === 'why' }"
                />
              </button>
              <div
                v-if="mobileDropdown === 'why'"
            ...
            <div>
              ...
              <div
                v-if="mobileDropdown === 'advertiser'"
                class="bg-white border-b border-gray-100"
              >
                <NuxtLink
                  to="/advertiser/how-to-operate"
            ...
            <div
              class="px-[2px] pt-12 pb-4 flex flex-col gap-4 border-gray-200"
            >
              <!-- 已登录状态：显示广告主管理按钮 -->
              <template v-if="isLoggedIn">
                <button
